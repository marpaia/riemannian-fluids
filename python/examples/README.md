...
- [`thin_shell_limits.py`](thin_shell_limits.py) builds the spherical tube chart with its exact Jacobian, extracts the wall-selected eigenvalue `6 alpha - 4 alpha^2`, constructs arbitrary smooth-core canonical-torus recoveries at both endpoints, and prints the closed mass and energy limits of the Navier regression mode.
