...
The present Lean code exposes a metric-compatible torsion-free connection *witness*. Existence and uniqueness of that connection, and the concrete calculus derived from it, remain obligations. They must be proved before an abstract operator identity can become a theorem about Riemannian surfaces.
...
1. concrete smooth vector fields and one-forms on an oriented Riemannian surface;
