...
| `CCG25-laplacian-gauss-family` | split: two proved fragments | constructed Gauss--Weingarten derivatives → differentiated jet → Bochner trace → adapted-basis Ricci split → Hodge formulas | construct the twice-differentiated jet and derive Codazzi and bracket--Weingarten from the immersion connection |
