...
| smooth local-field realization of the remaining CCG25 data | normal-form chart retraction, compatible scalar/tangent/along extensions, germ agreement, differentiability and arbitrary finite-order regularity preservation, a chart-independent symmetric continuous bilinear `II`, a locally induced Levi--Civita connection, and intrinsic Gauss are constructed; open: differentiate the fixed-chart Gauss germ and migrate `∇ᴮ II`, curvature, mean-curvature, and Hessian routes from the older global package |
